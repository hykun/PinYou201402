      ...
      <div id="rightBox">
        ...
        <ul id="navigationLinkBoxUl">
          <li class="navigationLinkLi">
            <a href="#!" class="addBlueBGColor">产品包装及个人隐私</a>
          </li>
          <li class="navigationLinkLi">
            <a href="#!">自主选择物流</a>
          </li>
        ...
        <ul id="textMainBoxUl">
          <li class="textMainLi textMainLiToBlock">
            <img src="../../images/helpCenterImg/distributionCommonQuestion1.jpg" alt="产品包装及个人隐私">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/distributionCommonQuestion2.jpg" alt="自主选择物流">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/distributionCommonQuestion3.jpg" alt="指定送货时间">
          </li>
        </ul>
