...
<html>
  <head>
    ...
    <title>现金券/优惠券如何使用_帮助中心_品优</title>
    ...
    <div id="mainBox">
      ...
      <div id="rightBox">
        ...
        <ul id="flowLinkBoxUl">
          ...
          <li class="flowLinkLi">
            <a href="#">&nbsp现金券/优惠券如何使用</a>
          </li>
        </ul>

        <!-- <ul id="navigationLinkBoxUl">
          <li class="navigationLinkLi">
            <a href="#!" class="addBlueBGColor">第一步</a>
          </li>
          <li class="navigationLinkLi">
            <a href="#!">第二步</a>
          </li>
        ...
        <ul id="textMainBoxUl">
          <li class="textMainLi textMainLiToBlock">
            <img src="../../images/helpCenterImg/howOrder1.jpg" alt="第一步">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/howOrder2.jpg" alt="第二步">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/howOrder3.jpg" alt="第三步">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/howOrder4.jpg" alt="第四步">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/howOrder5.jpg" alt="第五步">
          </li>
        </ul> -->
