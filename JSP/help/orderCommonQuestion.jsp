      ...
      <div id="rightBox">
        ...
        <ul id="navigationLinkBoxUl">
          <li class="navigationLinkLi">
            <a href="#!" class="addBlueBGColor">新用户注册</a>
          </li>
          <li class="navigationLinkLi">
            <a href="#!">没有邮箱怎么办</a>
          </li>
        ...
        <ul id="textMainBoxUl">
          <li class="textMainLi textMainLiToBlock">
            <img src="../../images/helpCenterImg/orderCommonQuestion1.jpg" alt="新用户注册">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/orderCommonQuestion2.jpg" alt="没有邮箱怎么办">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/orderCommonQuestion3.jpg" alt="为什么不能修改订单">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/orderCommonQuestion4.jpg" alt="验货签收">
          </li>
        </ul>

        <div id="rightBoxBottom">
          <a href="#">下一篇：现金券/优惠券如何使用</a>
        </div>
      </div>
    </div>
