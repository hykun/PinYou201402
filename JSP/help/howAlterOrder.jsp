      ...
      <div id="rightBox">
        ...
        <ul id="navigationLinkBoxUl">
          <li class="navigationLinkLi">
            <a href="#!" class="addBlueBGColor">修改收货人信息</a>
          </li>
          <li class="navigationLinkLi">
            <a href="#!">修改商品信息及支付方式</a>
          </li>
        </ul>

        <ul id="textMainBoxUl">
          <li class="textMainLi textMainLiToBlock">
            <img src="../../images/helpCenterImg/howAlterOrder1.jpg" alt="修改收货人信息">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/howAlterOrder2.jpg" alt="修改商品信息及支付方式">
          </li>
        </ul>
