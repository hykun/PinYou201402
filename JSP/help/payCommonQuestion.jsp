      ...
      <div id="rightBox">
        ...
        <ul id="navigationLinkBoxUl">
          <li class="navigationLinkLi">
            <a href="#!" class="addBlueBGColor">银行卡不支持在线支付</a>
          </li>
          <li class="navigationLinkLi">
            <a href="#!">在线支付出现问题</a>
          </li>
          <li class="navigationLinkLi">
            <a href="#!">查看积分、礼券、账户余额</a>
          </li>
        </ul>

        <ul id="textMainBoxUl">
          <li class="textMainLi textMainLiToBlock">
            <img src="../../images/helpCenterImg/payCommonQuestion1.jpg" alt="第一步">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/payCommonQuestion2.jpg" alt="第二步">
          </li>
          <li class="textMainLi">
            <img src="../../images/helpCenterImg/payCommonQuestion3.jpg" alt="第三步">
          </li>
        </ul>

        <div id="rightBoxBottom">
          <a href="#">下一篇：配送费收取标准</a>
        </div>
      </div>
    </div>
