...
<head>
  ...
  <%@include file="/pages/common/head.jsp"%>
   <div id="secondTitleBG">
    <div id="secondTitleBox">
      <div id="secondTitle">
        <p class="EngText">DISCOUNTS&nbsp&nbspARRIVE</p>
        <p>优惠专区<span></span></p>
      </div>
     </div>
    </div>
  <div id="mainBG">
    <div id="mainBox">
      <img id="bigImg" border="1" src="<s:property value="#request.get('javax.servlet.forward.context_path')"/>/upload/indexImg/16.jpg"><!-- 优惠专区页面大图 -->
      <div id="floatPicBox">
        <ul>
          <li id="textLi">
            <h4>COLLOCATION</h4>
