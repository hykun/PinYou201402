...
<head>
  ...
  <div id="mainBG">
    <div id="mainBox">
      <img id="bigImg" border="1" src="<s:property value="#request.get('javax.servlet.forward.context_path')"/>/upload/indexImg/13.jpg"><!-- 时尚饰品页面大图 -->
      <div id="floatPicBox">
        <ul>
          <li id="textLi">
            <h4>COLLOCATION</h4>
