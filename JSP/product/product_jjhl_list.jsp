...
<head>
     ...
     <title>居家护理_品优PINYOU</title>
      <link href="../CSS/public.css" type=text/css rel=stylesheet>
      <style type="text/css">

      div#menu{
        border-bottom:7px solid #9dd303;/*rewrite*/
      }
      ul#menuUl li a.homeLink{
        color:#2f2f2f;
      }
      ul#menuUl li a:hover{
        background-color: #9dd303;/*rewrite*/
        color:#f5ff98;/*rewrite*/
      }
      ...
      div#secondTitle{
        position: relative;
        top: 36px;
        border-left: 5px solid #9dd303;/*rewrite*/
        padding-left: 5px;
      }
      div#secondTitle p{
        margin: 0;
  ...
  <%@include file="/pages/common/head.jsp"%>
    ...
    <div id="secondTitleBox">
      <div id="secondTitle">
        <p class="EngText">HOME&nbsp&nbspCARE</p>
        <p>居家生活<span>系列</span></p>
      </div>
     </div>
    </div>
  <div id="mainBG">
    <div id="mainBox">
      <img id="bigImg" border="1" src="<s:property value="#request.get('javax.servlet.forward.context_path')"/>/upload/indexImg/14.jpg"><!-- 时尚饰品页面大图 -->
      <div id="floatPicBox">
        <ul>
          <li id="textLi">
            <h4>COLLOCATION</h4>
