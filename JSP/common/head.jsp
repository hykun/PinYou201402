...
<s:url action="customer_logout" namespace="/user" var="customer_logout"></s:url>
<!--  登录和注册 -->
...
<div id="topRightLink">
	...
	<a  class="topGreyLink"><s:property value="#session.customer.username"/></a>　
	<a  class="topGreyLink" href="${customer_logout}">退出</a>
</s:if> 
<s:else>
<a class="topGreyLink"  target="abc" href="${customer_login}">登录</a>
<a class="topGreyLink"  href="${customer_reg}">注册</s>
</s:else>

	
	 <a class="topGreyLink" href="#"><img width="11" height="13" src="/shop/images/logoMyCollect.jpg" />我的收藏</a>
<a  class="topGreyLink" href="${cart_list}">
	<img width="14" height="13" src="/shop/images/logoMarketBasket.jpg" /> 购物车</a> 
	<s:a id="payBottom" class="topGreyLink"  href="%{order_findByCustomer}">订单</s:a>　
</div>

     <div id="topBottomLink">
        <ul id="topBottomUl">
          <li><a href="/shop/pages/about/aboutEnterprise.jsp">关于企业</a></li>
          <li><a href="/shop/pages/about/aboutBrand.jsp">关于品牌</a></li>
          <li><a href="/shop/pages/about/joinIntroduce.jsp">加盟介绍</a></li>
          <li id="titleBoxLi"><a href="/shop/pages/index.jsp">品優</a></li>
          <li><a>收藏本站</a></li>
          <s:form action="product_findByName" method="post" namespace="/product">
                <li id="inputBoxLi">
	            <s:textfield name="name" placeholder="搜索您感兴趣的内容"></s:textfield><br>
		<%-- <b>热搜商品：</b>	
...
<a href="<s:url action="product_findEnjoyProduct" namespace="/product"></s:url>"><img src="${context_path}/css/images/index_16.gif" width="100" height="33" /></a>			 --%>
    <%-- <ul id="menuUl">
		...
		<div id="classicsUnderneath" class="menuUnderneath" >  <!-- 在这里显示出每个子类别 -->
   	  ...
   	  <s:action name="product_getByFontCategoryId"  namespace="/product" executeResult="true"> </s:action>		
        <%--   </li>
         </ul>
         </div>
        </li>
	    ...
	    <div id="lifeUnderneath" class="menuUnderneath">
         ...
         <li><a href="新品制定.html">新品制定</a></li>
      <li><a href="优惠专区.html">优惠专区</a></li>
